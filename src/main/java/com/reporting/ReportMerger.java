...
class ReportMerger {
    ...
    private void getListOfFailedScenarios(File reportDirectory) throws IOException {
        ...
        for (File rerunSourceReport : rerunSourceReports) {
            rerunFailedScenariosList.add(FileUtils.readFileToString(rerunSourceReport,"utf-8"));
        }
        ...
        FileUtils.writeStringToFile(mergedRerunReport, failedScenarios,"utf-8");
    }
    ...
    private void mergeJsonFiles(File jsonTarget, File jsonSource) throws IOException {
        ...
        //merge report files
        String targetReport = FileUtils.readFileToString(jsonTarget,"utf-8");
        String sourceReport = FileUtils.readFileToString(jsonSource,"utf-8");
        FileUtils.writeStringToFile(jsonTarget, targetReport.substring(0, targetReport.length() - 2) + "," + sourceReport.substring(1),"utf-8");
    }
